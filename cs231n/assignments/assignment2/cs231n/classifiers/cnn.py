...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # Hpool = 1 + (H - pool_height) / stride
        # Wpool = 1 + (W - pool_width) / stride
    ...
    def loss(self, X, y=None):
        ...
        h, h_cache = affine_relu_forward(crp, W2, b2)
        scores, scores_cache = affine_forward(h, W3, b3)
        ...
        dh, dW3, db3 = affine_backward(dscores, scores_cache)
        dcrp, dW2, db2 = affine_relu_backward(dh, h_cache)
